									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<s:iterator value="linkMans" var="c">
									...
									<TD><SPAN id=pagelink>
											<DIV
												...
												,当前第[<b>${page.currentPage }</b>]页 [<A
													href="${pageContext.request.contextPath }/linkman_list.action?cc=${page.nextPage}">下一页</A>]
												[<A
													href="${pageContext.request.contextPath }/linkman_list.action?cc=${page.lastPage}">上一页</A>]
