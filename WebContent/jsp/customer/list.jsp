			...
			<TR
				style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
							...
							<TD><s:property value="#c.custPhone"/></TD>
											...
											<td><a href="${pageContext.request.contextPath }/customer_updateCustomer.action?cid=${c.cid}" style="color: black;">修改</a>|<a href="${pageContext.request.contextPath }/customer_deleteCustomer.action?cid=${c.cid }" style="color: black;">删除</a></td>
			</TR>
			</s:iterator>
								...
								<h1></h1>
									<TD><SPAN id=pagelink>
											...
											,当前第[<b>${page.currentPage }</b>]页 
												[<A href="${pageContext.request.contextPath }/customer_list.action?cc=${page.nextPage}">下一页</A>]
												[<A href="${pageContext.request.contextPath }/customer_list.action?cc=${page.lastPage}">上一页</A>] 
