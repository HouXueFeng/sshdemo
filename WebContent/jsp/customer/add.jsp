...
<BODY>
	...
	<TR>
		...
		<INPUT class=textbox id=sChannel2
								style="WIDTH: 180px" maxLength=50 name="customer.custName">
		</td>
		<td>客户级别 ：</td>
		<td>
		<INPUT class=textbox id=sChannel2
								style="WIDTH: 180px" maxLength=50 name="customer.custLevel">
		</td>
	</TR>
	...
	<TR>																
		...
		<td>
		<INPUT class=textbox id=sChannel2
								style="WIDTH: 180px" maxLength=50 name="customer.custMobile">
		</td>
	</TR>
	<tr>
		<td rowspan=2>
